      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="origin-top-right absolute right-0 mt-2 w-72 rounded-md shadow-lg bg-[var(--card-bg)] ring-1 ring-[var(--border-color)] ring-opacity-5 focus:outline-none z-10 py-1"
            role="menu"
